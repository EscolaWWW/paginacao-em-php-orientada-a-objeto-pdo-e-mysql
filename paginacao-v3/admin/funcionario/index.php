...
if(isset($_POST['btCadastrar'])){
	if($objFunc->queryInsert($_POST) == 'ok'){
		header('location: /paginacao-v3/admin/funcionario');
	}else{
...
<nav class="navbar navbar-inverse navbar-radius">
  <div class="container-fluid">
    <ul class="nav navbar-nav">
      <li><a href="../../../paginacao-v3/admin">Home</a></li>
      <li class="active"><a href="#">Funcionários</a></li>
    </ul>
    <ul class="nav navbar-nav navbar-right">
      <li><a href="#"><span class="glyphicon glyphicon-user"></span> <?=$_SESSION['nome']?></a></li>
      <li><a href="/paginacao-v3/admin/funcionario/?sair=sim"><span class="glyphicon glyphicon-log-out"></span> Sair</a></li>
    </ul>
  </div>
</nav>
...
<div id="lista">
    <div class="panel panel-primary">
        ...
        <div class="panel-heading">
            ...
            <a href="/paginacao-v3/admin/funcionario" title="Cadastrar Funcionário"><img src="../../img/if_user-add_216490.png" width="32" height="32" alt="Cadastrar"></a>
        </div>	
        <!-- //CABECARIO -->
