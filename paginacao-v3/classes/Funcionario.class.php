...
class Funcionario{
	...
	public function sairFuncionario(){
		session_destroy();
		header('location: http://localhost/paginacao-v3');
	}
			...
			$html .= '<div class="panel-footer altr">';
				...
				if($pagina > 1){
                	...
                	$html .= '<ul class="pagination pagination-sm">';
                    	$html .= '<li><a href="/paginacao-v3/admin/funcionario/?pag='.($pagina - 1).'" title="Voltar" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>';
					$html .= '</ul>';
				}
				//BT NM PAGINA
                $html .= '<div class="alnNm">';
					if($ultima_pag <= 5){
						...
						for($a = 1; $a < $ultima_pag + 1; $a++){
							if($a == $pagina){
								$html .= '<li class="active"><a href="/paginacao-v3/admin/funcionario/?pag='.$a.'">'.$a.'</a></li>';
							}else{
								$html .= '<li><a href="/paginacao-v3/admin/funcionario/?pag='.$a.'">'.$a.'</a></li>';	
							}
						}
						$html .= '</ul>';
					}else{
						if($pagina < 1 + (2 * $adjacentes)){
							...
							$html .= '</ul>';
							// ULTIMAS PAGINAS
							$html .= '<ul class="pagination sprd"><li><span>...</span></li></ul>';
							$html .= '<ul class="pagination pagination-sm">';
								$html .= '<li><a href="/paginacao-v3/admin/funcionario/?pag='.($ultima_pag - 1).'">'.($ultima_pag - 1).'</a></li>';
								$html .= '<li><a href="/paginacao-v3/admin/funcionario/?pag='.$ultima_pag.'">'.$ultima_pag.'</a></li>';
							$html .= '</ul>';
							...
							//PRIMEIRAS PAGINAS -->
							$html .= '<ul class="pagination pagination-sm">';
								$html .= '<li><a href="/paginacao-v3/admin/funcionario/?pag=1">1</a></li>';
								$html .= '<li><a href="/paginacao-v3/admin/funcionario/?pag=2">2</a></li>';
							$html .= '</ul>';
							$html .= '<ul class="pagination sprd"><li><span>...</span></li></ul>';
							// PÁGINAS
							$html .= '<ul class="pagination pagination-sm">';
				...
				if($pagina < $ultima_pag){
                	...
                	$html .= '<ul class="pagination pagination-sm mgn"> '; 
                    	$html .= '<li><a href="/paginacao-v3/admin/funcionario/?pag='.($pagina + 1).'" title="Próximo" aria-label="Next"><span aria-hidden="true">&raquo;</span></a></li>';
					$html .= '</ul>';
				}
				$html .= '</nav>';
        	$html .= '</div>'; 
